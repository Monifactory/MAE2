...
//   * potentially possible with finer grained overwrites (is that even possible?)
//   * or asking AE2 to change their code to allow this
//   * 
...
//          if (craftingMachine
//            .pushPattern(patternDetails, inputHolder, adjPos.dir())) {
...
//        if (this.isBlocking()
//          && target.containsPatternInput(this.patternInputs)) {
//          continue;
//        }
//
//        if (this.adapterAcceptsAll(target, inputHolder)) {
//          patternDetails
//            .pushInputsToExternalInventory(inputHolder, (what, amount) -> {
...
//      adapters
//        .add(new TunneledPatternProviderTarget(null,
...
//        && potentialTunnel instanceof PatternP2PTunnelLogic) {
//        List<TunneledPatternProviderTarget> newTargets = ((PatternP2PTunnelLogic) potentialTunnel)
//          .getTargets();
//        if (newTargets != null) { adapters.addAll(newTargets); }
//      } else {
...
//    }
//
//    if (sendList.isEmpty()) { sendPos = null; }
//
//    return false;
//  }
//
...
//   * position found when the initial pattern was pushed. The position already
//   * has gone through potential p2p tunnels.
//   * 
//   * @author Stone
...
//      } else {
//        // when crafts are saved through a load, the cache won't exist but the
//        // send pos
//        // will
...
//      if (potentialTunnel instanceof PatternP2PTunnelLogic tunnel) {
...
//    return new PatternProviderTargetCache((ServerLevel) thisBe.getLevel(), pos,
//      dir, actionSource);
//  }
//
//  @Shadow
...
//    if (sendPos != null) { tag.putLong(SEND_POS_TAG, sendPos.asLong()); }
//  }
//
//  /**
