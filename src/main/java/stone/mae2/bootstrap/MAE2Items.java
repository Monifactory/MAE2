  ...
  public static void register() {
    PATTERN_P2P_TUNNEL = Util.make(() -> {
      ...
      return ITEMS.register("pattern_p2p_tunnel",
        () -> new PartItem<>(new Item.Properties(), PatternP2PTunnelPart.class,
          PatternP2PTunnelPart::new));
    });
    ...
    REDSTONE_MULTI_P2P_TUNNEL = Util.make(() -> {
      ...
      return ITEMS.register("redstone_multi_p2p_tunnel",
        () -> new PartItem<>(new Item.Properties(),
          RedstoneMultiP2PTunnel.Part.class, RedstoneMultiP2PTunnel.Part::new));
    });
    FE_MULTI_P2P_TUNNEL = Util.make(() -> {
      ...
      return ITEMS.register("fe_multi_p2p_tunnel",
        () -> new PartItem<>(new Item.Properties(), FEMultiP2PTunnel.Part.class,
          FEMultiP2PTunnel.Part::new));
    });
    ...
    FAULTY_MEMORY_CARD = ITEMS.register("faulty_card",
      FaultyMemoryCardItem::new);
  }
