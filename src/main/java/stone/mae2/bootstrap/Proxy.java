...
public interface Proxy {
  public class Server implements Proxy {
    public void init(IEventBus bus) {
      ...
      PartTooltips.addServerData(MultiP2PTunnel.Part.class,
  ...
  public class Client implements Proxy {
    ...
    public void init(IEventBus bus) {
      ...
      BuiltInModelHooks.addBuiltInModel(MAE2.toKey("item/faulty_card"),
        new FaultyCardModel());

      PartTooltips.addBody(MultiP2PTunnel.Part.class,
        new MultiP2PStateDataProvider());

      bus.addListener((RegisterColorHandlersEvent.Item event) -> {
        event.register(FaultyMemoryCardItem::getTintColor,
