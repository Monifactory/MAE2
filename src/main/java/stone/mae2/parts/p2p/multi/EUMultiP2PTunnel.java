...
public class EUMultiP2PTunnel extends MultiP2PTunnel<stone.mae2.parts.p2p.multi.EUMultiP2PTunnel.EUMultiP2PPart> {
    public static final short ID = MultiP2PService.register();
    ...
    public class EUMultiP2PPart extends CapabilityMultiP2PPart<EUMultiP2PPart, IEnergyContainer> {
        ...
        // I LOVE GENERICS!!!!
        // There's probably a better way than this but idk.
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public MultiP2PTunnel createTunnel() {
            return new EUMultiP2PTunnel();
        }

	@Override
	public short getTunnelID() {
            return EUMultiP2PTunnel.ID;
	}
}
}
